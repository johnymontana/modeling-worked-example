...
RETURN futureEvent.name, futureEvent.time, group.name, venue.name, commonTopics, myGroup, days, distance(point(venue), point({trainingLocation})) AS distance, myGroupScore + commonTopics - days AS score
ORDER BY score DESC
----
